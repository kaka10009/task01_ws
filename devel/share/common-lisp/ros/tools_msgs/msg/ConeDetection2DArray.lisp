...
(cl:defclass <ConeDetection2DArray> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (cones
    :reader cones
    :initarg :cones
    :type (cl:vector tools_msgs-msg:ConeDetection2D)
   :initform (cl:make-array 0 :element-type 'tools_msgs-msg:ConeDetection2D :initial-element (cl:make-instance 'tools_msgs-msg:ConeDetection2D))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <ConeDetection2DArray>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ConeDetection2DArray)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name tools_msgs-msg:<ConeDetection2DArray> is deprecated: use tools_msgs-msg:ConeDetection2DArray instead.")))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <ConeDetection2DArray>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'cones)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'tools_msgs-msg:ConeDetection2D))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<ConeDetection2DArray>)))
  ...
  "tools_msgs/ConeDetection2DArray")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ConeDetection2DArray)))
  "Returns string type for a message object of type 'ConeDetection2DArray"
  "tools_msgs/ConeDetection2DArray")
