...
(cl:defmethod cl:initialize-instance :after ((m <ConeDetection2D>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ConeDetection2D)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name loc_map_team-msg:<ConeDetection2D> is deprecated: use loc_map_team-msg:ConeDetection2D instead.")))

(cl:ensure-generic-function 'x1-val :lambda-list '(m))
(cl:defmethod x1-val ((m <ConeDetection2D>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader loc_map_team-msg:x1-val is deprecated.  Use loc_map_team-msg:x1 instead.")
  (x1 m))

(cl:ensure-generic-function 'y1-val :lambda-list '(m))
(cl:defmethod y1-val ((m <ConeDetection2D>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader loc_map_team-msg:y1-val is deprecated.  Use loc_map_team-msg:y1 instead.")
  (y1 m))

(cl:ensure-generic-function 'x2-val :lambda-list '(m))
(cl:defmethod x2-val ((m <ConeDetection2D>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader loc_map_team-msg:x2-val is deprecated.  Use loc_map_team-msg:x2 instead.")
  (x2 m))

(cl:ensure-generic-function 'y2-val :lambda-list '(m))
(cl:defmethod y2-val ((m <ConeDetection2D>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader loc_map_team-msg:y2-val is deprecated.  Use loc_map_team-msg:y2 instead.")
  (y2 m))

(cl:ensure-generic-function 'confidence-val :lambda-list '(m))
(cl:defmethod confidence-val ((m <ConeDetection2D>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader loc_map_team-msg:confidence-val is deprecated.  Use loc_map_team-msg:confidence instead.")
  (confidence m))
